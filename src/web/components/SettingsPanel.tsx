...
export function SettingsPanel({ rpcUrl, onRpcUrlChange, onExport, onImport, onClear }: SettingsPanelProps) {
  ...
  const saveRpc = async () => { await onRpcUrlChange?.(rpc); setNotice("Endpoint salvato"); };
